...
This paper addresses the problem of high communication cost of privacy-aware 
search which use bloom filters to measure the similarity score between the
...
also enables our system to search using keywords that 
...
search queries on encrypted data scales only linearly with the total number of 
